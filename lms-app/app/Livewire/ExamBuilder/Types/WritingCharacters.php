...
class WritingCharacters extends BaseQuestionEditor
{
    // Store correct Chinese character answers: [questionId => hanzi]
    ...
    public function addQuestion()
    {
        ...
        $q = $this->group->questions()->create([
            ...
            'question_type' => 'writing_characters',
            'order_index' => $maxOrder + 1,
            'points' => 1
        ]);

        // Create a single correct option record to hold the character
        $q->options()->create([
            'content' => '',
            'is_correct' => true,
            'order_index' => 1
    ...
    public function saveGroup()
    {
        ...
        $this->dispatch('notify', msg: __('Đã lưu phần thi Viết chữ Hán thành công!'), type: 'success');
    }

    public function render()
    {
        return view('livewire.exam-builder.types.writing-characters');
    }
}
