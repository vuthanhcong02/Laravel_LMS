...
class PinyinFixGridCommand extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($files as $file) {
            ...
            if (in_array($pinyinText, ['nv', 'nuu'])) {
                $display = 'nü';
            } elseif (in_array($pinyinText, ['nve', 'nuue', 'nue'])) {
                $display = 'nüe';
            } elseif (in_array($pinyinText, ['lv', 'luu'])) {
                $display = 'lü';
            } elseif (in_array($pinyinText, ['lve', 'luue', 'lue'])) {
                $display = 'lüe';
            }
    ...
    private function formatToneDisplay($original)
    {
        ...
        if (in_array($word, ['nv', 'nuu'])) {
            $word = 'nü';
        } elseif (in_array($word, ['nve', 'nuue', 'nue'])) {
            $word = 'nüe';
        } elseif (in_array($word, ['lv', 'luu'])) {
            $word = 'lü';
        } elseif (in_array($word, ['lve', 'luue', 'lue'])) {
            $word = 'lüe';
        } else {
