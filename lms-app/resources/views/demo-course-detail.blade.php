...
<head>
    ...
    <title>Bài 1: 你好！ - HSK 1 - XIAOMU LMS</title>
    <meta name="description" content="Chi tiết bài học HSK 1: 你好！ Từ vựng, Bài khóa, Ngữ pháp và Luyện tập.">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-5 no-scrollbar">
                <div>
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ url('/demo-courses') }}" class="flex items-center gap-3 rounded-xl text-xs nav-item-active transition-all btn-tactile" :class="sidebarCollapsed ? 'justify-center p-2.5' : 'px-3.5 py-2.5'" :title="sidebarCollapsed ? 'Khóa học HSK' : ''">
