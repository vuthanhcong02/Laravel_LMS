<div class="w-full flex flex-col items-center" x-data="quizGameComponent()">
    ...
    <div class="flex items-center justify-center gap-3 mb-8 bg-slate-100/50 dark:bg-slate-800/50 p-2 rounded-xl border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-md">
        ...
        <button @click="viewMode = 'match'" class="px-5 py-2.5 rounded-lg text-slate-600 dark:text-slate-300 font-bold text-sm hover:bg-white dark:hover:bg-slate-700 hover:shadow-sm transition-all active:scale-95 flex items-center gap-2">
            <span class="material-symbols-outlined text-[18px]">extension</span> Nối từ
        </button>
        <button class="px-5 py-2.5 rounded-lg bg-white dark:bg-slate-700 text-purple-600 dark:text-purple-400 font-black text-sm shadow-md transition-all flex items-center gap-2">
