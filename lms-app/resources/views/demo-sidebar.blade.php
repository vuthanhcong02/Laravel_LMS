<!DOCTYPE html>
<html lang="vi" class="h-full" :class="{ 'dark': darkMode }" x-data="{ sidebarOpen: false, langOpen: false, currentLang: 'Việt Nam', darkMode: false, rankTab: 'week', rankMetric: 'time' }">
<head>
    <meta charset="UTF-8">
...
<body class="h-full antialiased bg-[#f8f6f3] dark:bg-[#0e0c0b] text-slate-800 dark:text-slate-100 selection:bg-[#e07a5f] selection:text-white transition-colors duration-200">
    ...
    <div class="flex h-full w-full overflow-hidden relative">
        ...
        <!-- Sidebar Navigation -->
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-[#141211] border-r border-[#e8e2d9] dark:border-[#262220] flex flex-col transition-transform duration-300 ease-out lg:static lg:translate-x-0 shrink-0"
               :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'">
            
            <!-- KHU VỰC LOGO THƯƠNG HIỆU -->
            <div class="h-20 flex items-center justify-between px-5 border-b border-[#e8e2d9] dark:border-[#262220]">
            ...
            <!-- Menu chính -->
            <nav class="flex-1 overflow-y-auto py-5 px-3 space-y-6 no-scrollbar">
                
                <!-- Nhóm Học tập -->
                <div>
                    <div class="text-[11px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest px-3 mb-2">Học tập</div>
                    <div class="space-y-1">
                        <!-- Trang chủ -->
                        <a href="{{ route('home') }}" class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm nav-item-active transition-all btn-tactile">
                            <i class="fa-solid fa-house text-base w-5 text-center"></i>
                            <span>Trang chủ</span>
                        </a>

                        <!-- Khóa học -->
                        <a href="{{ route('courses') }}" class="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-all btn-tactile">
                            <i class="fa-solid fa-book-open text-slate-400 dark:text-slate-500 text-base w-5 text-center group-hover:text-[#e07a5f] transition-colors"></i>
                            <span>Khóa học</span>
                        </a>

                        <!-- Thi thử HSK -->
                        <a href="{{ route('student.hsk-mock-exams.index') }}" class="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-all btn-tactile">
                            <i class="fa-solid fa-file-pen text-slate-400 dark:text-slate-500 text-base w-5 text-center group-hover:text-[#e07a5f] transition-colors"></i>
                            <span>Thi thử HSK</span>
                        </a>

                        <!-- Thẻ ghi nhớ -->
                        <a href="{{ route('flashcards') }}" class="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-all btn-tactile">
                            <i class="fa-solid fa-layer-group text-slate-400 dark:text-slate-500 text-base w-5 text-center group-hover:text-[#e07a5f] transition-colors"></i>
                            <span>Thẻ ghi nhớ</span>
                        </a>

                        <!-- Bảng phiên âm Pinyin -->
                        <a href="{{ route('pinyin.index') }}" class="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-all btn-tactile">
                            <i class="fa-solid fa-table-cells text-slate-400 dark:text-slate-500 text-base w-5 text-center group-hover:text-[#e07a5f] transition-colors"></i>
                            <span>Bảng phiên âm Pinyin</span>
                        </a>

                        <!-- Luyện tập Pinyin -->
                        <a href="{{ route('pinyin.quiz') }}" class="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-all btn-tactile">
                            <i class="fa-solid fa-circle-question text-slate-400 dark:text-slate-500 text-base w-5 text-center group-hover:text-[#e07a5f] transition-colors"></i>
                            <span>Luyện tập Pinyin</span>
                        </a>

                        <!-- Góc chia sẻ (Blog) -->
                        <a href="{{ route('blog') }}" class="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-all btn-tactile">
                            <i class="fa-solid fa-newspaper text-slate-400 dark:text-slate-500 text-base w-5 text-center group-hover:text-[#e07a5f] transition-colors"></i>
                ...
                <div>
                    <div class="text-[11px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest px-3 mb-2">Hệ thống</div>
                    <div class="space-y-1">
                        <!-- Liên hệ -->
                        <a href="{{ route('contact') }}" class="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-all btn-tactile">
                            <i class="fa-solid fa-envelope text-slate-400 dark:text-slate-500 text-base w-5 text-center group-hover:text-[#e07a5f] transition-colors"></i>
                            <span>Liên hệ hỗ trợ</span>
                        </a>

                        <!-- Cài đặt -->
                        <a href="{{ route('settings.index') }}" class="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-all btn-tactile">
                            <i class="fa-solid fa-gear text-slate-400 dark:text-slate-500 text-base w-5 text-center group-hover:text-[#e07a5f] transition-colors"></i>
            ...
            <div class="p-4 m-3 rounded-2xl bg-gradient-to-br from-[#fff2ee] to-[#fdeae3] dark:from-slate-800 dark:to-slate-900 border border-[#fcdccf] dark:border-slate-700 shadow-xs relative overflow-hidden">
                ...
                <p class="text-xs text-slate-600 dark:text-slate-300 mb-3 leading-relaxed">Mở khóa toàn bộ các bộ đề thi HSK 1 - HSK 6 nâng cao.</p>
                <button class="w-full py-2 bg-[#e07a5f] hover:bg-[#c86349] text-white font-bold rounded-xl text-xs shadow-md transition-all btn-tactile hover:shadow-lg">
                    Nâng cấp ngay
                </button>
            </div>

            <!-- Chân trang Hồ sơ cá nhân -->
            <div class="p-4 border-t border-[#e8e2d9] dark:border-[#262220] bg-[#faf6f2] dark:bg-slate-900/60">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3 min-w-0">
                        <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=120&q=80" class="w-9 h-9 rounded-full object-cover border border-slate-200 dark:border-slate-700">
                        <div class="truncate">
                            <p class="text-sm font-bold text-slate-900 dark:text-white truncate">Vũ Thành Công</p>
                            <p class="text-[11px] font-semibold text-[#e07a5f] truncate">Học viên HSK 5</p>
                        </div>
                    </div>
                    <button class="text-slate-400 hover:text-red-500 p-1.5 rounded-lg transition-colors btn-tactile">
        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <!-- Topbar Header -->
            <header class="h-20 bg-white dark:bg-[#141211] border-b border-[#e8e2d9] dark:border-[#262220] flex items-center justify-between px-4 sm:px-6 lg:px-10 shrink-0 gap-4 transition-colors">
                
                <!-- Ô tìm kiếm & Nút mở Menu Mobile -->
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    ...
                    <!-- Chuỗi Ngày học -->
                    <div class="hidden xs:flex items-center gap-1.5 sm:gap-2 bg-[#fff2ee] dark:bg-[#251d1a] border border-[#fcdccf] dark:border-[#42271f] px-3 py-1.5 rounded-xl shadow-xs">
                    ...
                    <!-- Thông báo -->
                    <button class="relative w-9 h-9 rounded-xl bg-white dark:bg-slate-800 border border-[#e8e2d9] dark:border-slate-700 text-slate-500 dark:text-slate-300 hover:text-slate-800 flex items-center justify-center transition-all btn-tactile">
                        <i class="fa-regular fa-bell"></i>
                        <span class="absolute top-2 right-2 w-2 h-2 bg-[#e07a5f] rounded-full animate-ping"></span>
                        <span class="absolute top-2 right-2 w-2 h-2 bg-[#e07a5f] rounded-full"></span>
                    </button>
                </div>
            </header>

            <!-- Nội dung Trang chủ -->
            <div class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-10 custom-scroll pb-20 lg:pb-10 no-scrollbar">
            ...
            <div class="lg:hidden fixed bottom-0 inset-x-0 bg-white dark:bg-[#141211] border-t border-[#e8e2d9] dark:border-[#262220] flex items-center justify-around py-2.5 px-2 z-30 shadow-md">
                ...
                <a href="{{ route('courses') }}" class="flex flex-col items-center gap-0.5 text-slate-400 hover:text-slate-700 dark:hover:text-white btn-tactile">
                    <i class="fa-solid fa-book-open text-base"></i>
                    <span class="text-[10px] font-medium">Khóa học</span>
                </a>
                <a href="{{ route('student.hsk-mock-exams.index') }}" class="flex flex-col items-center gap-0.5 text-slate-400 hover:text-slate-700 dark:hover:text-white btn-tactile">
                    <i class="fa-solid fa-file-pen text-base"></i>
                    <span class="text-[10px] font-medium">Thi thử</span>
                </a>
                <a href="{{ route('settings.index') }}" class="flex flex-col items-center gap-0.5 text-slate-400 hover:text-slate-700 dark:hover:text-white btn-tactile">
