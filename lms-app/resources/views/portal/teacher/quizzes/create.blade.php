        ...
        <div class="max-w-4xl mx-auto space-y-8">
            <div class="flex items-center justify-between pb-2 mt-5 border-b border-slate-100 dark:border-slate-800">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-black text-slate-800 dark:text-white">{{ __('Khởi tạo Bài thi') }}</h1>
                        <p class="text-slate-500 font-medium text-sm">{{ __('Thiết lập thông tin cơ bản cho bài kiểm tra') }}</p>
                    </div>
                </div>
            </div>
