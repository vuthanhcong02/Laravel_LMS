                    ...
                    <div class="max-h-[320px] overflow-y-auto">
                        ...
                        <a href="#"
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-slate-800 dark:text-slate-200">Khóa học mới</p>
                                <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-2">Bạn vừa được
                                    phân công giảng dạy khóa học HSK 3.</p>
                        ...
                        <a href="#"
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-slate-800 dark:text-slate-200">Nộp bài tập</p>
                                <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-2">Học viên
                                    Nguyễn Văn B vừa nộp bài tập cuối khóa.</p>
                                <p class="text-[10px] text-slate-400 mt-1.5 font-medium">1 giờ trước</p>
                            </div>
                        </a>
                        ...
                        <a href="#"
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm font-medium text-slate-800 dark:text-slate-200">Câu hỏi mới</p>
                                <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-2">Có một câu hỏi
                                    mới trong phần thảo luận bài 5.</p>
                                <p class="text-[10px] text-slate-400 mt-1.5 font-medium">Hôm qua</p>
                            </div>
                        </a>
                    </div>
                    <a href="#"
            ...
            <div class="relative" x-data="{ userMenuOpen: false }">
                <button @click="userMenuOpen = !userMenuOpen"
                    ...
                    <div class="hidden lg:flex flex-col items-start leading-tight">
                        ...
                        <span class="text-xs text-primary font-medium">Giáo viên</span>
                    </div>
                ...
                <div x-show="userMenuOpen" @click.outside="userMenuOpen = false" x-cloak
                    ...
                    <div class="py-1">
                        <a href="{{ route('teacher.profile.edit') }}"
                            ...
                            <span class="material-symbols-outlined text-base">manage_accounts</span> Hồ sơ cá nhân
                        </a>
                        <a href="{{ route('settings.index') }}"
                            class="flex items-center gap-3 px-4 py-2 text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                            <span class="material-symbols-outlined text-base">settings</span> Cài đặt
                        </a>
                    </div>
