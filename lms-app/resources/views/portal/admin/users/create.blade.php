        ...
        <div class="max-w-[800px] mx-auto space-y-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500">Add a new admin, teacher, or student to the platform.</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST"
                ...
                <div class="pt-4 flex justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-6 py-2 rounded-lg font-bold bg-primary text-white hover:bg-primary/90 transition-colors">Create
                        User</button>
                </div>
            </form>
        </div>
