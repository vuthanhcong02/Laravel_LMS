    ...
    <main class="flex-1 p-6 lg:p-8 overflow-y-auto">
        <div class="max-w-[1200px] mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-slate-900 dark:text-white">New Blog Post</h1>
                    <p class="text-sm text-slate-500">Fill in the details below to create a new post.</p>
                </div>
            </div>

            <form id="blog-form" action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-5" x-data="blogForm()">
                    ...
                    <div class="lg:col-span-2 space-y-5">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <span x-text="slug || 'your-post-slug'"
                                    class="text-xs text-primary font-mono truncate"></span>
                            </div>
                        </div>
