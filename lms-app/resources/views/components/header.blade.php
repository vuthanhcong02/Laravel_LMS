@php
    ...
    $isHskActive = request()->routeIs('flashcards') || request()->routeIs('student.quizzes.*') || request()->routeIs('courses');
    $isBlogActive = request()->routeIs('blog');
    $isContactActive = request()->routeIs('contact');
@endphp

<header
    x-data="{ mobileMenuOpen: false, openHSK: false }"
...
>
    <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center gap-2">
            <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-primary text-white shadow-sm shadow-primary/20">
                <span class="material-symbols-outlined">translate</span>
            </div>
            <h2 class="text-xl font-black tracking-tight text-slate-900 dark:text-white">
                XiaoMu <span class="text-primary font-black">Chinese</span>
            </h2>
        </div>
        ...
        <nav class="hidden md:flex items-center gap-8">
            ...
            <div 
                class="relative" 
                @mouseenter="openHSK = true" 
                @mouseleave="openHSK = false"
                @click.away="openHSK = false"
            >
                <button 
                    @click="openHSK = !openHSK"
                ...
                >
                    ...
                    <span class="material-symbols-outlined text-[18px] transition-transform duration-200" :class="openHSK ? 'rotate-180' : ''">expand_more</span>
                </button>
                    ...
                    <div class="space-y-1">
                        ...
                        >
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-[9px] font-medium text-slate-400 dark:text-slate-500 mt-1.5">Luyện nhớ chữ Hán và phiên âm</p>
                            </div>
                        </a>
                        ...
                        >
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-[9px] font-medium text-slate-400 dark:text-slate-500 mt-1.5">Học theo lộ trình bài bản</p>
                            </div>
                        </a>
                        ...
                        >
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-[9px] font-medium text-slate-400 dark:text-slate-500 mt-1.5">Đánh giá năng lực thực tế</p>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="flex items-center gap-3">
            ...
            @else
                <!-- Guest Actions -->
                <a href="{{ route('login') }}"
                    class="px-5 py-2 text-sm font-bold text-slate-700 dark:text-slate-200 hover:text-primary transition-colors">Đăng nhập</a>
                <a href="{{ route('register') }}"
                    class="rounded-xl bg-primary px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all">Đăng ký</a>
            @endauth
            ...
            >
                <span class="material-symbols-outlined text-[22px] font-bold" x-text="mobileMenuOpen ? 'close' : 'menu'">menu</span>
            </button>
        </div>
    </div>
    ...
    >
        <div class="px-6 py-4 flex flex-col gap-4" x-data="{ mobileHSKOpen: false }">
            ...
            <div class="border-b border-slate-100 dark:border-slate-800/80 pb-2">
                <button 
                    @click="mobileHSKOpen = !mobileHSKOpen"
                ...
                >
                    ...
                    <span class="material-symbols-outlined text-[20px] transition-transform duration-200" :class="mobileHSKOpen ? 'rotate-180' : ''">expand_more</span>
                </button>

                <!-- Accordion Content List -->
                <div 
                    x-show="mobileHSKOpen" 
                    x-transition:enter="transition ease-out duration-200 transform"
                    x-transition:enter-start="-translate-y-2 opacity-0"
                    x-transition:enter-end="translate-y-0 opacity-100"
                    class="mt-2 pl-9 flex flex-col gap-3"
                >
                    <!-- Flashcard -->
                    <a href="{{ route('flashcards') }}"
