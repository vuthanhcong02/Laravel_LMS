        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="flex flex-col gap-8">
                ...
                <div class="flex gap-4">
                    <a class="w-12 h-12 flex items-center justify-center rounded-full bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 hover:bg-primary hover:text-white transition-all"
                        href="https://www.facebook.com/profile.php?id=61589009699142" target="_blank" rel="noopener noreferrer" title="Facebook Tiếng Trung XiaoMu">
                    ...
                    <a class="w-12 h-12 flex items-center justify-center rounded-full bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200 hover:bg-primary hover:text-white transition-all"
                        href="https://www.tiktok.com/@chiettuchuhan55" target="_blank" rel="noopener noreferrer" title="TikTok Tiếng Trung XiaoMu">
                ...
                <div
                    ...
                    <div class="absolute inset-0 bg-cover bg-center"
                        data-alt="Bản đồ vị trí trung tâm Tiếng Trung XiaoMu tại Hà Nội" data-location="Hanoi, Vietnam"
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-slate-100 dark:border-slate-700 p-8">
                ...
                <form id="contact-form" action="{{ route('contact.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2.5">
                            <label class="cursor-pointer">
                                ...
                                <div
                                    class="px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm font-semibold text-slate-600 dark:text-slate-400 peer-checked:bg-primary/10 peer-checked:text-primary peer-checked:border-primary hover:border-primary/40 transition-all">
                                    Tư vấn khóa học
                                </div>
                            </label>
                            <label class="cursor-pointer">
                    ...
                    <button
                        class="w-full py-3 bg-primary text-white font-bold rounded-2xl text-sm hover:opacity-90 shadow-lg shadow-primary/30 transition-all flex items-center justify-center gap-2"
                        type="submit">
