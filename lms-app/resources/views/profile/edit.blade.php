...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <!-- Header Breadcrumb & Tiêu đề trang -->
    ...
    <!-- Layout 2 cột: Cột trái (Tóm tắt hồ sơ & Menu) - Cột phải (Form nội dung tab) -->
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        
        <!-- CỘT TRÁI: Thẻ Tóm tắt hồ sơ cá nhân (Hero Card) -->
        <div class="lg:col-span-4 space-y-4">
            
            <!-- Card Thông tin User & Avatar -->
            <div class="lms-card overflow-hidden"
                ...
                <div class="px-5 pb-5 pt-0 relative">
                    ...
                    <div class="grid grid-cols-2 gap-2.5 mt-4 pt-4 border-t border-[#e8e2d9] dark:border-[#2d2926]">
                        <div class="p-2.5 rounded-xl bg-[#f8f6f3] dark:bg-[#201d1b] border border-[#e8e2d9] dark:border-[#2d2926] text-center">
                            <span class="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">{{ __('Mục tiêu') }}</span>
                            <span class="text-xs font-bold text-[#e07a5f] mt-0.5 inline-block">{{ __('HSK 5 Cao cấp') }}</span>
                        </div>
                        <div class="p-2.5 rounded-xl bg-[#f8f6f3] dark:bg-[#201d1b] border border-[#e8e2d9] dark:border-[#2d2926] text-center">
                            <span class="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">{{ __('Chuỗi học') }}</span>
                            <span class="text-xs font-bold text-amber-500 mt-0.5 inline-block">🔥 {{ __('14 ngày') }}</span>
                        </div>
                    </div> --}}
            ...
            <!-- Menu Tabs điều hướng chuyển đổi -->
        ...
        <!-- CỘT PHẢI: Card Nội dung Form theo từng Tab -->
