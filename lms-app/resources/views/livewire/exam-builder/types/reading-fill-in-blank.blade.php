    ...
    <div class="space-y-4">
        ...
        <div class="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-start gap-3 p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg relative group">
                    ...
                    <button wire:click="removeTextOption({{ $idx }})" class="absolute -right-2 -top-2 w-6 h-6 bg-red-500 text-white rounded-full hidden group-hover:flex items-center justify-center hover:bg-red-600 shadow-md">
                        <span class="material-symbols-outlined text-sm">close</span>
                    </button>
                </div>
                @endforeach
            </div>
            <button wire:click="addTextOption" class="mt-3 flex items-center gap-1 text-xs font-bold text-primary hover:text-primary-dark">
