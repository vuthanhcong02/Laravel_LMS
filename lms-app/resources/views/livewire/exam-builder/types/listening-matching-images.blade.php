                ...
                <div class="bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-bold text-slate-700 dark:text-slate-300 text-sm">Câu hỏi âm thanh</span>
                        </div>
                    ...
                    <div class="mt-4 pl-11 flex flex-col gap-4">
                        <div class="w-full">
                            ...
                            <textarea wire:model="questionTitles.{{ $index }}" rows="2" placeholder="Ví dụ: Nữ: Nǐ hǎo! / Nam: Nǐ hǎo!..." class="w-full text-sm rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 focus:ring-primary focus:border-primary"></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <select wire:model="correctAnswers.{{ $question->id }}" class="text-sm rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 font-bold focus:ring-primary focus:border-primary">
                                ...
                                @foreach(['A','B','C','D','E','F'] as $letter)
                                    <option value="{{ $letter }}">Ảnh {{ $letter }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
