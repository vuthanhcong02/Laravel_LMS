<!DOCTYPE html>
<html lang="vi" class="h-full" :class="{ 'dark': darkMode }" x-data="authLoginPage">
<head>
    <meta charset="UTF-8">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="{{ __('Nhập địa chỉ email của bạn') }}" 
