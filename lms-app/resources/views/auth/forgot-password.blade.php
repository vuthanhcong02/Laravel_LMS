<!DOCTYPE html>
<html lang="vi" class="h-full" :class="{ 'dark': darkMode }" x-data="authForgotPage">
<head>
    <meta charset="UTF-8">
            ...
            <div class="lms-card p-6 sm:p-10 space-y-6">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-700 dark:text-slate-300">{{ __('Địa chỉ Email đã đăng ký') }}</label>
                        <div class="relative">
