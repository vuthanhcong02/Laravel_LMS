<!DOCTYPE html>
<html lang="vi" class="h-full" :class="{ 'dark': darkMode }" x-data="authResetPasswordPage">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Đặt lại mật khẩu - XiaoMu Tiếng Trung LMS</title>
        ...
        <div class="w-full max-w-md">
            <div class="lms-card p-6 sm:p-10 space-y-6">
                ...
                <div class="text-center space-y-2">
                    ...
                    <h2 class="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Đặt lại mật khẩu 🔑</h2>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus placeholder="{{ __('Nhập địa chỉ email của bạn') }}" 
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-700 dark:text-slate-300">{{ __('Mật khẩu mới') }}</label>
                        <div class="relative">
                            <i class="fa-solid fa-lock absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
                            <input :type="showPassword ? 'text' : 'password'" name="password" required placeholder="{{ __('Nhập mật khẩu mới của bạn') }}" 
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-700 dark:text-slate-300">{{ __('Xác nhận mật khẩu mới') }}</label>
                        <div class="relative">
                            <i class="fa-solid fa-shield-halved absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 text-sm"></i>
                            <input :type="showConfirmPassword ? 'text' : 'password'" name="password_confirmation" required placeholder="{{ __('Nhập lại mật khẩu mới để xác nhận') }}" 
                                   class="w-full bg-[#f8f6f3] dark:bg-[#201d1b] border border-[#e8e2d9] dark:border-[#2d2926] rounded-xl pl-10 pr-10 py-3 text-xs sm:text-sm text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:border-[#e07a5f] focus:ring-2 focus:ring-[#e07a5f]/20 transition-all">
