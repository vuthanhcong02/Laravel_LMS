                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus placeholder="example@gmail.com" 
                    ...
                    <!-- Ô Mật khẩu Mới -->
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-700 dark:text-slate-300">Mật khẩu mới</label>
                        <div class="relative">
                    ...
                    <div class="space-y-1.5">
                        <label class="text-xs font-bold text-slate-700 dark:text-slate-300">Xác nhận mật khẩu mới</label>
                        <div class="relative">
